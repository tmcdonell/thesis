...
extern "C" __global__ void foldAll(const Int64 shIn0_0, const Int64 shIn1_0, const Int64 shOut_0, float* __restrict__ arrOut_0)
{
extern volatile __shared__ float sdata0[];
float x0;
float y0;
const Int64 sh0 = min(shIn0_0, shIn1_0);
...
y0 = indexArray(arrIn0_0, v1) * indexArray(arrIn1_0, v1);
for (ix += gridSize; ix < shapeSize; ix += gridSize) {
const Int64 v1 = ({ assert(ix >= 0 && ix < min(shIn0_0, shIn1_0)); ix; });

x0 = indexArray(arrIn0_0, v1) * indexArray(arrIn1_0, v1);
y0 = x0 + y0;
}
}
