...
extern "C" __global__ void stencil2(const Int64 shOut_1, const Int64 shOut_0, float* __restrict__ arrOut_0, const Int64 shStencil1_1, const Int64 shStencil1_0, const Int64 shStencil2_1, const Int64 shStencil2_0)
{
...
const float x4 = indexArray(arrStencil1_0, w4);
...
arrOut_0[ix] = 0.25f * (x4 + y5 + y7 + y3 + y1);
} else {
const Int64 w8 = sh1 * shStencil1_0 + sh0;
const float x4 = indexArray(arrStencil1_0, w8);
