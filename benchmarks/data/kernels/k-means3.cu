...
const Int64 v13_1 = v13_0 / shIn1_0;
const Int64 v14 = v13_1 % shIn0_0;
const Int64 v15 = v13_0 % shIn1_0;
const float v16 = indexArray(arrIn1_1, v15);
const float v17 = indexArray(arrIn1_0, v15);
...
Word32 lv201;
float lv200;
const Word32 v21 = indexArray(arrIn0_2, lv182);
const float v22 = indexArray(arrIn0_1, lv182);
const float v23 = indexArray(arrIn0_0, lv182);
...
y1 = v28 ? indexArray(arrIn1_1, v15) : 0.0f;
y0 = v28 ? indexArray(arrIn1_0, v15) : 0.0f;
}
...
x1 = v28 ? indexArray(arrIn1_1, v15) : 0.0f;
x0 = v28 ? indexArray(arrIn1_0, v15) : 0.0f;
if (ix >= start) {
y2 = x2 + y2;
y1 = x1 + y1;
y0 = x0 + y0;
