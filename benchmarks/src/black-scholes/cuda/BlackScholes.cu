...
//    checkCudaErrors(cudaMalloc((void **)&d_PutResult,    opt_sz));
    ...
    for (i = 0; i < num_iterations; i++)
    {
        ...
        checkCudaErrors(cudaMemcpy(h_PutResultGPU,  d_PutResult,  opt_sz, cudaMemcpyDeviceToHost));     // TLM
        checkCudaErrors(cudaMemcpy(h_CallResultGPU, d_CallResult, opt_sz, cudaMemcpyDeviceToHost));     // TLM
