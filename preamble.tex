...
\newcommand{\footcode}[1]{\lstinline[style=inline,basicstyle=\scriptsize\sourcecodepro]{#1}}
...
\newcommand\AST{AST\index{abstract-syntax tree}}
\newcommand\CUDA{\indext{CUDA}}
\newcommand\GPU{GPU\index{graphics processing unit}}
\newcommand\HOAS{HOAS\index{higher-order abstract syntax}}
