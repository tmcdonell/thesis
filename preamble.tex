...
\newcommand{\gpu}[1][]{\index{graphics processing unit!#1}}
\newcommand{\gpgpu}[1][]{\index{general-purpose computing on graphics processing units}}
\newcommand{\cuda}[1][]{\index{CUDA!#1}}
