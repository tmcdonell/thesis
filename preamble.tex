...
\providecommand{\AST}[1][]{\index{abstract syntax tree!#1}}
\providecommand{\cuda}[1][]{\index{CUDA!#1}}
\providecommand{\fusion}[1][]{\index{fusion!#1}}
\providecommand{\gpu}[1][]{\index{graphics processing unit!#1}}
\providecommand{\gpgpu}[1][]{\index{general-purpose computing on graphics processing units}}
...
\index{GPU|see {graphics processing unit}}
\index{GPGPU|see {general-purpose computing on graphics processing units}}
