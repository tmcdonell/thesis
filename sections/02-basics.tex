...
the partial block sums includes the seed element. We note that, although the
current implementation discards all but the last element of each of the
sub-arrays in step 1, this behaviour may not be necessary. A critical
