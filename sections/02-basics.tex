...
More specifically, the GPU\gpu{} is especially well suited to expressing
...
locally in shared memory\cuda[shared memory]{}\cuda{}. The inclusive scan algorithm
...
that GPU\gpu{} computing, and CUDA\cuda{} in particular, are data-parallel
programming models. Finally, we have introduced the idea of embedded
domain-specific languages\lang[domain-specific]{}\lang[embedded]{}.
