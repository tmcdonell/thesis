...
value at index $y$ is taken from $x = f (y)$ in $X$. Although this operation is
not difficult to implement, it is worth mentioning since it is not commonly
found outside of data parallel programming.
