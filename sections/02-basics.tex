...
be used for general purpose computing, not just graphics.
...
flattening transformation~\cite{Blelloch:1995ut}. If future work adds support
for nested parallelism, it may be beneficial to implement segmented scans
directly rather than by operator
