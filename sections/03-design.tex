...
DirectX 9 shader model, and does not offer higher-order combinators such as
@map@ and @fold@.
...
Baracuda~\cite{Larsen:2011fa} is another Haskell EDSL producing CUDA GPU
kernels, though it is intended to be used offline, with the kernels called
directly from a C++ application.
