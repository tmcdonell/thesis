...
\paragraph{Haskell-based approaches}
...
\paragraph{C++-based approaches}

Accelerator~\cite{Bond:2010bd,Tarditi:2006} is a library-based approach with
...
includes a fusion mechanism. Finally, Thrust~\cite{ThrustAParallelT:ub} is a
library of algorithms written in CUDA, with an interface similar to the C++
