...
Similarly, we extent the Accelerate scalar language with a @Foreign@ node, to
...
\end{lstlisting}
\marginnote{tk: put into compilation section?}
...
manner, and has several backend targets including CPUs and GPUs.
