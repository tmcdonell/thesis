...
will be generated for equivalent operations. Thus, we will still be able to
reuse generated kernels~(\S\ref{sec:caching_compiled_kernels}).
...
% spreadsheet that ships as part of the CUDA toolkit.
