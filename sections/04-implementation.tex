...
data HostArray where
  HostArray   :: exists e. Typeable e
              => Int                            -- unique ID to the device execution context
...
quantified array type. Furthermore the host arrays are tagged with a integer
identifier, which is used to support mapping the host array to multiple devices
and execution contexts. The implementation of the lookup operation follows
closely that of \citet{PeytonJones:2000ks}.
