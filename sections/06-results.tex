...
\begin{figure}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{images/sec-6/mandelbrot}
    \end{center}
...
\begin{lstlisting}[style=haskell_float
    ...
    ,caption={Mandelbrot set generator in Accelerate, using fixed unrolling}]
mandelbrot
...
\begin{lstlisting}[style=haskell_float
    ...
    ,caption={Mandelbrot set generator in Accelerate, using explict iteration}]
mandelbrot
    :: forall a. (Elt a, IsFloating a)
    => Int
    -> Int
...
\begin{lstlisting}[style=haskell_float
    ,label=lst:nbody
    ,caption={$N$-body gravitational simulation in Accelerate, using parallel reduction}]
...
\begin{lstlisting}[style=haskell_float
    ,label=lst:nbody_seq
    ,caption={$N$-body gravitational simulation in Accelerate, using sequential reduction}]
