...
\textbf{Name}   & \parbox[b]{12ex}{\centering Non-zeros\\(nnz/row)}
                ...
                & \multicolumn{1}{c}{\begin{sideways}\parbox{10ex}
...
However, matrices such as FEM/Spheres, with few non-zero elements per row
