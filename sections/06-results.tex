...
generated code requires 628 instructions (one block at 128 threads per block)
...
single multiplication. The CUDA version executes 652 instructions per thread
block (128 threads).
