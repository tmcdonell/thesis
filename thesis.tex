...
\newcommand{\doctitle}{Optimising Purely Functional GPU Programs}
\newcommand{\docsubtitle}{}
%\newcommand{\doccontentsline}{Functional Programming for GPUs}
\newcommand{\doccontentsline}{\doctitle}
...
\include{sections/03-accelerate}
